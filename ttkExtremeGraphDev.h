...
///
/// \ingroup vtk
/// \class ttkExtremeGraphDev
/// \author Your Name Here <your.email@address.here>
/// \date The Date Here.
///
/// \brief TTK VTK-filter that wraps the ttk::ExtremeGraphDev module.
///
/// This VTK filter uses the ttk::ExtremeGraphDev module to compute an averaging of
...
///   - standalone/ExtremeGraphDev/main.cpp
///
/// See the related ParaView example state files for usage examples within a
/// VTK pipeline.
///
/// \sa ttk::ExtremeGraphDev
/// \sa ttkAlgorithm

#pragma once

// VTK Module
#include <ttkExtremeGraphDevModule.h>
...
// TTK Base Includes
#include <ExtremeGraphDev.h>


//用于拓扑持久度计算
struct SaddlePersistence {
    int saddleIdx;    // index in CandidateSaddlePoints
    double persistence;
};

class TTKEXTREMEGRAPHDEV_EXPORT ttkExtremeGraphDev
  : public ttkAlgorithm // we inherit from the generic ttkAlgorithm class
  ,
    protected ttk::ExtremeGraphDev // and we inherit from the base class
{
private:
  /**
  ...
  std::string extremePointsName{"ExtremePoints"};
...
public:
   ...
   */
  static ttkExtremeGraphDev *New();
  vtkTypeMacro(ttkExtremeGraphDev, ttkAlgorithm);
...
protected:
   ...
   */
  ttkExtremeGraphDev();
  ~ttkExtremeGraphDev() override = default;
